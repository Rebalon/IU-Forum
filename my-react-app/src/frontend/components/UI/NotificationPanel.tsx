...
const NotificationPanel: React.FC = () => {
  ...
  const fetchNotifications = async () => {
    ...
    try {
      const response = await fetch(`https://iu-forum.onrender.com/api/getNotifications`, {
        method: 'POST',
        headers: {
  ...
  const markAsRead = async (id: number) => {
    ...
    try {
      const response = await fetch('https://iu-forum.onrender.com/api/markNotificationAsRead', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const markAllAsRead = async (type: 'notification' | 'message') => {
    ...
    try {
      const response = await fetch('https://iu-forum.onrender.com/api/markAllNotificationsAsRead', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
