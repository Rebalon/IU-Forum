  ...
  useEffect(() => {
    const fetchRecentActivity = async () => {
      try {
        ...
        const threadsResponse = await fetch('https://iu-forum.onrender.com/api/getTopicAndAllThread');
        ...
        // Fetch recent topics
        const topicsResponse = await fetch('https://iu-forum.onrender.com/api/getAllCategoryAndTopic');
